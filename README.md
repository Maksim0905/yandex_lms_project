...
- [WebSockets](https://websockets.readthedocs.io/) – Технология для обеспечения реального времени взаимодействия между клиентом и сервером.
- [Docker](https://www.docker.com/) – Платформа для разработки, доставки и запуска приложений.
- [JWT](https://jwt.io/) – Стандарт для передачи утверждений между сторонами.
